...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57ac7df4acb657_97250163',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ac7df4acb657_97250163')) {function content_57ac7df4acb657_97250163($_smarty_tpl) {?>
            <div class="row" 
                    >
	...
	<ul>
	        		...
	        		<a target="_blank" href="https://www.google.com/+prestashop" class="btn-tooltip" data-original-title="Google Plus" rel="publisher">
	        			<span>Google Plus</span>
                            ...
                            >
                                                                                                <div id="custhtmlcarosel8420" class="block custhtmlcarosel">
        	<a class="carousel-control left" href="#custhtmlcarosel8420"   data-slide="prev">&lsaquo;</a>
	<a class="carousel-control right" href="#custhtmlcarosel8420"  data-slide="next">&rsaquo;</a>
...
$(document).ready(function() {
    $('#custhtmlcarosel8420').each(function(){
        $(this).carousel({
            pause: true,
            interval: false
        });
