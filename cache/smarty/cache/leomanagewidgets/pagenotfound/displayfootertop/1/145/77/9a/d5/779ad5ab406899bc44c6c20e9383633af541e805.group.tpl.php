...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57ac8078052722_31555213',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ac8078052722_31555213')) {function content_57ac8078052722_31555213($_smarty_tpl) {?>
            <div class="row" 
                    >
	...
	<ul>
	        		...
	        		<a target="_blank" href="https://www.google.com/+prestashop" class="btn-tooltip" data-original-title="Google Plus" rel="publisher">
	        			<span>Google Plus</span>
                            ...
                            >
                                                                                                <div id="custhtmlcarosel31270" class="block custhtmlcarosel">
        	<a class="carousel-control left" href="#custhtmlcarosel31270"   data-slide="prev">&lsaquo;</a>
	<a class="carousel-control right" href="#custhtmlcarosel31270"  data-slide="next">&rsaquo;</a>
...
$(document).ready(function() {
    $('#custhtmlcarosel31270').each(function(){
        $(this).carousel({
            pause: true,
            interval: false
        });
